...
```{teacher, echo = FALSE, results = "asis"}
cat(mc_opts("`0  4  6  8  1  3  5  7`",
         "`0  2  4  6 -1  1  3  5`",
         "`2  4  6  8  1  3  5  7 -2`",
         "`-4  -8 -12 -16  -2  -6 -10 -14`",
         correct = 2))
...
```{teachr, echo = FALSE, results = "asis"}
cat(mc_opts("`8 1 3 5`",
         "`8 1 3`",
         "`6 8 1 3`",
         "`1 3 5`",
...
```{r, echo = FALSE, results = "asis"}
cat(teachr::mc_opts("student_result <- c(99,77,35,97,67,85)",
         "student_result <- c(77,99,35,97,67,85)",
         "student_result <- c(97,77,35,99,67,85)",
         "student_result <- c(100,77,35,99,67,85)",
         correct = 3))
```
