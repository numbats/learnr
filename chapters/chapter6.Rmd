...
```{r plot-06-06C, code = read_lines("../exercises/solution_06_06C.R"), echo = FALSE}
```
...
```
```{r plot-06-06D, code = read_lines("../exercises/solution_06_06D.R"), echo = FALSE, cache = FALSE}
```
...
```{r plot-06-06E, code = read_lines("../exercises/solution_06_06E.R"), echo = FALSE, cache = FALSE}
```
