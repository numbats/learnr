...
It semantically changes your code in a way that makes it more intuitive to both read and write. To illustrate the idea, below is a simplified example with mathematical opeations:
