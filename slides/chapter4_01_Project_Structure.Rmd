...
* To disable this function in RStudio, go to `Tools`  `r icons::fontawesome("arrow-circle-right", style = "solid")`  `Global Options` `r icons::fontawesome("arrow-circle-right", style = "solid")`  `General` 
