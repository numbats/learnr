...
<img src="chapter1-02/RStudio_interface_1.png" width="80%" style="display: block; margin: auto;" />
...
<img src="chapter1-02/RStudio_Add_script.png" width="80%" style="display: block; margin: auto;" />
...
<img src="chapter1-02/RStudio_rscript_1.png" width="80%" style="display: block; margin: auto;" />
...
<img src="chapter1-02/RStudio_package.png" width="80%" style="display: block; margin: auto;" />
...
<img src="chapter1-02/RStudio_Install_pkg.png" width="80%" style="display: block; margin: auto;" />

Note: The first way is by clicking. Open the `Pacakges` window on the
bottom right, click on `Install`
![](/tmp/RtmpQZBvVD/file47ba18a5801b.png){height="0.7em"}.
...
<img src="chapter1-02/RStudio_tools.png" width="80%" style="display: block; margin: auto;" />

Note: Customise your RStudio, go `Tools`
![](/tmp/RtmpQZBvVD/file47ba49c25cc6.png){height="0.7em"}
`Global Options..`
...
-   If you are not able to download package from this sources, go to
    `Global Options...`
    ![](/tmp/RtmpQZBvVD/file47ba67945af9.png){height="0.7em"} `Packages`
    ![](/tmp/RtmpQZBvVD/file47ba3705d4a9.png){height="0.7em"}
...
<img src="chapter1-02/RStudio_apprenve.png" width="80%" style="display: block; margin: auto;" />

Note: You can also change the appearance of your RStudio from the
`Global Options...`
![](/tmp/RtmpQZBvVD/file47ba58ee7e11.png){height="0.7em"} `Appearance`.
