...
knitr::include_graphics("adding_rmd.png", error = FALSE)
```

---

```{r, echo=FALSE, out.width="70%"}
knitr::include_graphics("naming.png", error = FALSE)
```
...
```{r, echo=FALSE, out.width="70%"}
knitr::include_graphics("rmd-demo.png", error = FALSE)
```
...
knitr::include_graphics("demo-first-rmd.png", error = FALSE)
```
...
```{r, echo=FALSE, out.width="80%"}
knitr::include_graphics("demo-knit-html.png", error = FALSE)
```
...
```{r, echo=FALSE, out.width="80%"}
knitr::include_graphics("demo-knit-pdf.png", error = FALSE)
```
