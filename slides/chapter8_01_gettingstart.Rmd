...
knitr::include_graphics("images/chapter8/adding_rmd.png")
```

---

```{r, echo=FALSE, out.width="70%"}
knitr::include_graphics("images/chapter8/naming.png")
```
...
```{r, echo=FALSE, out.width="70%"}
knitr::include_graphics("images/chapter8/rmd-demo.png")
```
...
knitr::include_graphics("images/chapter8/demo-first-rmd.png")
```
...
```{r, echo=FALSE, out.width="80%"}
knitr::include_graphics("images/chapter8/demo-knit-html.png")
```
...
```{r, echo=FALSE, out.width="80%"}
knitr::include_graphics("images/chapter8/demo-knit-pdf.png")
```
