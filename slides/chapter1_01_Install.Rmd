...
knitr::opts_chunk$set(fig.path = "chapter1-01/",
                      fig.align = "center",
                      fig.width = 2, 
                      fig.height = 2,
                      cache.path = "cache/",
...
```{r, echo=FALSE}
knitr::include_graphics("chapter1-01/R_Install_CRAN.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("chapter1-01/R_Install_Mac.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("chapter1-01/R_Install_Mac_1.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("chapter1-01/R_Install_Mac_2.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("chapter1-01/R_Install_Mac_3.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("chapter1-01/R_Install_Mac_4.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("chapter1-01/R_Install_Mac_5.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("chapter1-01/RStudio_Install.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("chapter1-01/RStudio_Install_Mac_1.png")
```
