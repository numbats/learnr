...
::: {.cell layout-align="center"}
::: {.cell-output-display}
![](images/chapter8-01/slr-plot-1.png){fig-align='center' width=384}
:::
:::
...
::: {.cell layout-align="center"}
::: {.cell-output-display}
![](images/chapter8-01/residuals-1.png){fig-align='center' width=1152}
:::
:::
...
::: {.cell layout-align="center"}
::: {.cell-output-display}
![](images/chapter8-01/plot-fits-1.png){fig-align='center' width=960}
:::
:::
...
* You can use calculus to find this or consult any standard first year statsitics text book. 
...
* To get the model parameter estimates, referred to also as **coefficients**, you can use `coef` function on the model object:
...
* You can see sueful information from  `summary(fit)` but it is not easy to extract it as a tidy data. 
