...
- `case_when()`: This command takes multiple conditions and tests them in order. You should order the tests from specific to general, and keep track of how those ambiguous rows are being treated. `TRUE` here is equivalent to the `else` statement.
